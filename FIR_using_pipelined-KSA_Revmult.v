`timescale 1ps/1ns
module FIR_using_pipelined-KSA_Revmult (
    input wire clk,
    input wire rst,
    ...
    adder add0 (clk,rst,mult_out[0], mult_out[1], sum_stage[0]);
    adder add1 (clk,rst,mult_out[2], mult_out[3], sum_stage[1]);
    adder add2 (clk,rst,mult_out[4], mult_out[5], sum_stage[2]);
    adder add3 (clk,rst,mult_out[6], mult_out[7], sum_stage[3]);

    adder add4 (clk,rst,sum_stage[0], sum_stage[1], sum_stage[4]);
    adder add5 (clk,rst,sum_stage[2], sum_stage[3], sum_stage[5]);

    adder add6 (clk,rst,sum_stage[4], sum_stage[5], data_out);
...
module adder (
    ...
    output wire [15:0] sum
	 ...
	 wire cout;
    ksa_pipe ksa(clk,rst,a,b,sum,cout);
	 //assign sum=a+b;
endmodule
module ksa_pipe (
  input clk,
  ...
  wire cin;
  wire [15:0] p0, g0, c0;
  wire [15:0] p1, g1, ps1, c1;
  wire [15:0] p2, g2, ps2, c2;
  wire [15:0] p3, g3, ps3, c3;
  wire [15:0] p4, g4, ps4, c4;
  wire [15:0] c_final;
  ...
  reg [15:0] p0_r, g0_r;
  reg [15:0] p1_r, g1_r, ps1_r;
  reg [15:0] p2_r, g2_r, ps2_r;
  reg [15:0] p3_r, g3_r, ps3_r;
  reg [15:0] p4_r, g4_r, ps4_r;
